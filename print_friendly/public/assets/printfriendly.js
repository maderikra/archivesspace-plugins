...
$( ".content-pane .row-fluid .span9" ).attr( "id", "print_content" );
     ...
     if ($("#printlink").length == 0){
	   $( ".title-pane .row-fluid .span3").append( '<br /><div id=\"printlink\" style=\"text-align:center\"><img src=\"/assets/printer_icon.png\"><a href=\"#\" onclick=\"window.open(\'/assets/print.html\')\">Print Friendly</a></div>' );
	  }
